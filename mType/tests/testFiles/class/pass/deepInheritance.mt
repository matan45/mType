...
class Being {
    ...
    public constructor(string kingdom) {
...
class Animal extends Being {
    ...
    public constructor(string species): super("Animalia") {
...
class Mammal extends Animal {
    ...
    public constructor(string species, bool hasFur): super(species) {
        this.hasFur = hasFur;
...
class Dog extends Mammal {
    ...
    public constructor(string breed): super("Canis familiaris", true) {
        this.breed = breed;
