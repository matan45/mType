// Complex integration: Namespaces + Classes + Final variables
...
gameEngine::Entity player = new gameEngine::Entity("Player");
gameEngine::Entity enemy = new gameEngine::Entity("Enemy");

print(player.getId());
print(enemy.getId());
print(gameEngine::Entity::getNextId());

gameEngine::physics::Vector3 position = new gameEngine::physics::Vector3(1.0, 2.0, 3.0);
print(position.magnitude());

int frame1 = gameEngine::rendering::renderEntity(player);
int frame2 = gameEngine::rendering::renderEntity(enemy);
print(frame1);
print(frame2);

// Test using directives with complex namespaces
