...
dataProcessing::DataProcessor processor = new dataProcessing::DataProcessor();
...
string analysis = dataProcessing::analytics::analyzeResults(result, processed);
print(analysis);

// Test multiple processors
dataProcessing::DataProcessor processor2 = new dataProcessing::DataProcessor();
