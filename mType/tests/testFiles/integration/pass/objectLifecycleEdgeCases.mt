...
lifecycleTest::testRapidObjectCreationDestruction();
lifecycleTest::testObjectArrayLifecycle();
lifecycleTest::testFunctionParameterLifecycle();
lifecycleTest::testRecursiveObjectCreation();
lifecycleTest::testObjectSharingScenario();