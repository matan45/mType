...
resourceTest::testRAIIPattern();
resourceTest::testResourceTransferPattern();
resourceTest::testExceptionSafeResource();
resourceTest::testResourcePoolPattern();
resourceTest::testNestedResourceCleanup();