...
cleanupTest::testCircularReferenceCleanup();
cleanupTest::testNestedObjectCleanup();
cleanupTest::testObjectReassignmentCleanup();
cleanupTest::testExceptionSafeCleanup();