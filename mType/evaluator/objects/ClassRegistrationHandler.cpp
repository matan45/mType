...
namespace objects {
    ...
    void ClassRegistrationHandler::validateInterfaceImplementations(std::shared_ptr<ClassDefinition> classDef, ClassNode* node)
    {
        auto env = context->getEnvironment();
    ...
    std::pair<std::string, std::vector<std::string>> ClassRegistrationHandler::parseGenericInterfaceName(const std::string& interfaceName)
    {
